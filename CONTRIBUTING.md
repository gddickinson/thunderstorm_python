# Contributing to thunderstorm_python
...
[GitHub issue](https://github.com/gddickinson/thunderstorm_python/issues) rather than emailing —
...
2. **What happened** versus what you expected. Paste the full traceback if there
   was one.
3. **Your data** — the localization settings used, camera pixel size and gain, and how the result differs from the original ImageJ thunderSTORM if you compared them.
